...
def get_first_notes(rated, note_from, note_to, cutoff, *, re_auth_thresh = 2):
    ...
    # filter to only notes written by the 4 major algorithms
    # CHANGED 2026-08-29 to include ExpansionPlusModel
    first_notes = first_notes[first_notes['decidedBy']\
        .isin(['CoreModel (v1.1)', 'ExpansionModel (v1.1)',
        'ExpansionPlusModel (v1.1)', 'CoreWithTopicsModel (v1.1)'])]

    print("Now we have " + str(len(first_notes)) + " notes written by the 4 major algorithms")
